...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/topix/detail/BaseTopixFragment$halfDynPubOb$1$1.class */
public final class BaseTopixFragment$halfDynPubOb$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final BaseTopixFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BaseTopixFragment$halfDynPubOb$1$1(BaseTopixFragment baseTopixFragment, Continuation<? super BaseTopixFragment$halfDynPubOb$1$1> continuation) {
        super(2, continuation);
        this.this$0 = baseTopixFragment;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new BaseTopixFragment$halfDynPubOb$1$1(this.this$0, continuation);
    }
