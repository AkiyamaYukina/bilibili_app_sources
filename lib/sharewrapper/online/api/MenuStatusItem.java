...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/lib/sharewrapper/online/api/MenuStatusItem.class */
@Keep
public class MenuStatusItem {
    ...
    public MenuStatusItem(String str, String str2, int i7) {
        this.name = str;
        this.level = str2;
        this.iconResId = i7;
    }
    ...
    public MenuStatusItem(String str, String str2, String str3, int i7) {
        this.name = str;
        this.iconUrl = str2;
        this.level = str3;
        this.iconResId = i7;
