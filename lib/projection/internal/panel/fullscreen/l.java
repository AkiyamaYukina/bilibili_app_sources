...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/lib/projection/internal/panel/fullscreen/l.class */
public final class l<T, R> implements Function {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final ProjectionFullScreenActivity f63423a;

    public l(ProjectionFullScreenActivity projectionFullScreenActivity) {
        this.f63423a = projectionFullScreenActivity;
    }
    ...
    public final Object apply(Object obj) {
        ...
        ProjectionFullScreenActivity projectionFullScreenActivity = this.f63423a;
