...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/lib/projection/internal/widget/fullscreen/newui/ProjectionNewUiPositionTextWidget.class */
public final class ProjectionNewUiPositionTextWidget extends AppCompatTextView implements InterfaceC7755c {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    @Nullable
    public InterfaceC5317a f64002a;
    ...
    /* JADX INFO: loaded from: bili_base.jar:com/bilibili/lib/projection/internal/widget/fullscreen/newui/ProjectionNewUiPositionTextWidget$a.class */
    public static final class a implements ProjectionSeekBarWidget.a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final ProjectionNewUiPositionTextWidget f64005a;

        public a(ProjectionNewUiPositionTextWidget projectionNewUiPositionTextWidget) {
            this.f64005a = projectionNewUiPositionTextWidget;
        }
        ...
        public final void a(int i7, int i8) {
            ...
            this.f64005a.setText(str);
        }
    }

    public ProjectionNewUiPositionTextWidget(@NotNull Context context) {
        super(context);
        this.f64004c = new a(this);
    }

    public ProjectionNewUiPositionTextWidget(@NotNull Context context, @Nullable AttributeSet attributeSet) {
    ...
    public final void b(InterfaceC7845m interfaceC7845m) {
        ...
        InterfaceC5317a interfaceC5317a = this.f64002a;
