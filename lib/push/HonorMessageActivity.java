...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/lib/push/HonorMessageActivity.class */
@EntryAwait(create = {"infra.opt.awaitPush"})
public class HonorMessageActivity extends ActivityC7846a {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        BPushLog.e("HonorMessageActivity", "start HonorPush activity");
