...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/pegasus/channelv2/detail/tab/baike/adapter/LoadListStatus.class */
public final class LoadListStatus {
    ...
    public static final LoadListStatus SUCCESS = new LoadListStatus(BCGToken.SCHEDULE_STATUS_SUCCESS, 1);
    ...
    private static final /* synthetic */ LoadListStatus[] $values() {
        return new LoadListStatus[]{LOADING, SUCCESS, ERROR, NO_MORE};
    }
