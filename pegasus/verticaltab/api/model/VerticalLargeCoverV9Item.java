...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/pegasus/verticaltab/api/model/VerticalLargeCoverV9Item.class */
@Keep
public class VerticalLargeCoverV9Item extends BasePlayerItem implements ICardFollowingStateArgsItem, g, d, c, f.a {
    ...
    public Video.PlayableParams getInternalInlinePlayableParams() {
        ...
        b.a(inlineUgcPlayableParams, this, 0, 12);
        b.c(inlineUgcPlayableParams, this);
        inlineUgcPlayableParams.setSpmid("main.composite-tab.0.0");
        inlineUgcPlayableParams.setFromSpmid("main.composite-tab.0.0");
    ...
    */
    public boolean getLikeState() {
        ...
        L1a:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bilibili.pegasus.verticaltab.api.model.VerticalLargeCoverV9Item.getLikeState():boolean");
    }
