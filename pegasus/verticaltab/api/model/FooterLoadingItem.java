...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/pegasus/verticaltab/api/model/FooterLoadingItem.class */
@StabilityInferred(parameters = 0)
@Keep
public final class FooterLoadingItem extends BasicIndexItem {
    public static final int $stable = 8;

    public FooterLoadingItem() {
        ((BasicIndexItem) this).cardType = "footer_loading";
    }
