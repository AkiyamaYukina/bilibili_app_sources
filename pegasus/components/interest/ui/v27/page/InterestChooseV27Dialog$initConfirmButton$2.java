...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/pegasus/components/interest/ui/v27/page/InterestChooseV27Dialog$initConfirmButton$2.class */
final class InterestChooseV27Dialog$initConfirmButton$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final InterestChooseV27Dialog this$0;

    /* JADX INFO: renamed from: com.bilibili.pegasus.components.interest.ui.v27.page.InterestChooseV27Dialog$initConfirmButton$2$1, reason: invalid class name */
    /* JADX INFO: loaded from: bili_base.jar:com/bilibili/pegasus/components/interest/ui/v27/page/InterestChooseV27Dialog$initConfirmButton$2$1.class */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<C7779b, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            C4872l0 c4872l04 = interestChooseV27Dialog.h;
            if (c4872l04 != null && (tintTextView = c4872l04.f54086c) != null) {
                tintTextView.setTextColor(interestChooseV27Dialog.getResources().getColor(c7779b.f122929c ? R$color.Wh0_u : R$color.Text3));
            }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InterestChooseV27Dialog$initConfirmButton$2(InterestChooseV27Dialog interestChooseV27Dialog, Continuation<? super InterestChooseV27Dialog$initConfirmButton$2> continuation) {
        super(2, continuation);
        this.this$0 = interestChooseV27Dialog;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new InterestChooseV27Dialog$initConfirmButton$2(this.this$0, continuation);
    }
