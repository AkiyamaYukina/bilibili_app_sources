...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/pegasus/components/interest/ui/v27/page/InterestChooseV27Dialog$handleConfirmButtonClicked$1.class */
final class InterestChooseV27Dialog$handleConfirmButtonClicked$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final InterestChooseV27Dialog this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InterestChooseV27Dialog$handleConfirmButtonClicked$1(InterestChooseV27Dialog interestChooseV27Dialog, Continuation<? super InterestChooseV27Dialog$handleConfirmButtonClicked$1> continuation) {
        super(2, continuation);
        this.this$0 = interestChooseV27Dialog;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new InterestChooseV27Dialog$handleConfirmButtonClicked$1(this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        InterestChooseV27PageViewModel interestChooseV27PageViewModel;
        ArrayList arrayList;
        ...
        if (i7 == 0) {
            ...
            if (interestChooseV27PageViewModel2 != null && (flow = interestChooseV27PageViewModel2.f76506n) != null) {
                this.label = 1;
        ...
        if (c7779b != null) {
            ...
            if (interestChooseV27PageViewModel3 == null || (stateFlow = interestChooseV27PageViewModel3.f76495b) == null || (interestChoose = (InterestChoose) stateFlow.getValue()) == null) {
                return Unit.INSTANCE;
            }
            ...
            if (z6) {
                ...
                int i9 = 0;
                interestChooseV27Dialog.f76375e = false;
                interestChooseV27Dialog.f76376f = true;
            ...
            } else if (i8 == 0 && c7779b.f122929c && (interestChooseV27PageViewModel = c.f76482a) != null) {
                interestChooseV27PageViewModel.g(1);
            }
            return Unit.INSTANCE;
        }
        return Unit.INSTANCE;
