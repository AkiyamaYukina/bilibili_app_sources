...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/pegasus/components/interest/ui/v29/page/InterestChooseV29FirstTab$initRv$2$1.class */
final class InterestChooseV29FirstTab$initRv$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public InterestChooseV29FirstTab$initRv$2$1(InterestChooseV29FirstTab interestChooseV29FirstTab, Object obj, InterestChoose interestChoose, Continuation<? super InterestChooseV29FirstTab$initRv$2$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new InterestChooseV29FirstTab$initRv$2$1(this.this$0, this.$item, this.$data, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (obj2 instanceof InterestChooseGender) {
            ...
            if (!interestChooseGender.f77411g) {
                ...
                if (interestChooseV29PageViewModel != null) {
                    MutableStateFlow<InterestChoose> mutableStateFlow = interestChooseV29PageViewModel.f76548a;
            ...
            if (!interestChooseAge.f77403e) {
                ...
                if (interestChooseV29PageViewModel2 != null) {
                    MutableStateFlow<InterestChoose> mutableStateFlow2 = interestChooseV29PageViewModel2.f76548a;
