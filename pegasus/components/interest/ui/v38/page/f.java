...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/pegasus/components/interest/ui/v38/page/f.class */
public final /* synthetic */ class f implements DialogInterface.OnKeyListener {
    ...
    public final boolean onKey(DialogInterface dialogInterface, int i7, KeyEvent keyEvent) {
        ...
        com.bilibili.pegasus.components.interest.e.s(interestChoose.D(), interestChoose.O(), InterestPageReturnReason.GESTURE, InterestPageType.INTEREST_2ND, interestChoose.B());
        return false;
    }
}
