...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/pegasus/components/interest/ui/v33/page/InterestChooseV33FirstTab$initRv$2$1.class */
final class InterestChooseV33FirstTab$initRv$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public InterestChooseV33FirstTab$initRv$2$1(InterestChooseV33FirstTab interestChooseV33FirstTab, Object obj, InterestChoose interestChoose, Continuation<? super InterestChooseV33FirstTab$initRv$2$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new InterestChooseV33FirstTab$initRv$2$1(this.this$0, this.$item, this.$data, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (obj2 instanceof InterestChooseGender) {
            ...
            if (!interestChooseGender.f77411g) {
                ...
                if (interestChooseV33PageViewModel != null) {
                    MutableStateFlow<InterestChoose> mutableStateFlow = interestChooseV33PageViewModel.f76741e;
                    ...
                    if (interestChoose2 != null && (listQ = interestChoose2.q()) != null) {
                        ...
                        if (interestChoose3 != null) {
                            ...
                            interestChooseA2 = InterestChoose.a(interestChoose3, null, mutableList, null, 536870847);
                        }
                        mutableStateFlow.setValue(interestChooseA2);
                    }
                }
            }
            ...
            if (!interestChooseAge.f77403e) {
                ...
                if (interestChooseV33PageViewModel2 != null) {
                    MutableStateFlow<InterestChoose> mutableStateFlow2 = interestChooseV33PageViewModel2.f76741e;
                    ...
                    if (interestChoose4 != null && (listC = interestChoose4.c()) != null) {
                        ...
                        if (interestChoose5 != null) {
                            ...
                            interestChooseA = InterestChoose.a(interestChoose5, null, null, mutableList2, 536870783);
                        }
                        mutableStateFlow2.setValue(interestChooseA);
                    }
                }
            }
        }
