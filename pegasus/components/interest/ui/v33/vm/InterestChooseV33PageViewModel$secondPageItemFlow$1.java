...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/pegasus/components/interest/ui/v33/vm/InterestChooseV33PageViewModel$secondPageItemFlow$1.class */
public final class InterestChooseV33PageViewModel$secondPageItemFlow$1 extends SuspendLambda implements Function3<Integer, List<? extends InterestChooseItem>, Continuation<? super a>, Object> {
    int I$0;
    Object L$0;
    int label;

    public InterestChooseV33PageViewModel$secondPageItemFlow$1(Continuation<? super InterestChooseV33PageViewModel$secondPageItemFlow$1> continuation) {
        super(3, continuation);
    }

    public final Object invoke(int i7, List<InterestChooseItem> list, Continuation<? super a> continuation) {
        InterestChooseV33PageViewModel$secondPageItemFlow$1 interestChooseV33PageViewModel$secondPageItemFlow$1 = new InterestChooseV33PageViewModel$secondPageItemFlow$1(continuation);
        interestChooseV33PageViewModel$secondPageItemFlow$1.I$0 = i7;
        interestChooseV33PageViewModel$secondPageItemFlow$1.L$0 = list;
        return interestChooseV33PageViewModel$secondPageItemFlow$1.invokeSuspend(Unit.INSTANCE);
    }
