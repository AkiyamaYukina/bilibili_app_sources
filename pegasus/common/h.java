...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/pegasus/common/h.class */
@StabilityInferred(parameters = 0)
public final class h extends InlineCardTaskRepository {

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    @NotNull
    public final BasePegasusPlayerData f75521l;

    public h(@NotNull BasePegasusPlayerData basePegasusPlayerData) {
        this.f75521l = basePegasusPlayerData;
    }
    ...
    public final Pair<ChronosScene, ChronosBiz> getChronosSceneAndBiz() {
        return new Pair<>(ChronosScene.SCENE_PEGASUS_INLINE_NEW, ChronosBiz.BIZ_OGV);
    }
    ...
    public final void onUpdateStaffFollowState(@NotNull List<UpdateVideoDetailState.FollowState> list) {
        ...
        ICardFollowingStateArgsItem iCardFollowingStateArgsItem = this.f75521l;
