...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/playerbizcommonv2/danmaku/input/panel/commandsdetail/mark/MarkRelatedGoodsItem$requestGoodsList$1.class */
final class MarkRelatedGoodsItem$requestGoodsList$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final long $avid;
    int label;
    final f this$0;

    /* JADX INFO: loaded from: bili_base.jar:com/bilibili/playerbizcommonv2/danmaku/input/panel/commandsdetail/mark/MarkRelatedGoodsItem$requestGoodsList$1$a.class */
    public static final class a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final MarkGoodsList f81074a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        public final f f81075b;

        public a(MarkGoodsList markGoodsList, f fVar) {
            this.f81074a = markGoodsList;
            this.f81075b = fVar;
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MarkRelatedGoodsItem$requestGoodsList$1(f fVar, long j7, Continuation<? super MarkRelatedGoodsItem$requestGoodsList$1> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (itemList != null && !itemList.isEmpty()) {
            ...
            bundle.putInt("mark_goods_dialog_height", this.this$0.f81093b.f());
            ...
            f fVar = this.this$0;
            markGoodsDialog.f81073f = new a(markGoodsList, fVar);
            FragmentActivity fragmentActivityFindFragmentActivityOrNull = ContextUtilKt.findFragmentActivityOrNull(fVar.getContext());
