...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/tgwt/im/ui/ChatMsgFragment$clickMsg$1.class */
final class ChatMsgFragment$clickMsg$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX INFO: loaded from: bili_base.jar:com/bilibili/tgwt/im/ui/ChatMsgFragment$clickMsg$1$a.class */
    public static final class a extends TypeToken<ChatMessageVo> {
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChatMsgFragment$clickMsg$1(ChatMsgFragment chatMsgFragment, ArrayMap<String, String> arrayMap, Context context, long j7, Continuation<? super ChatMsgFragment$clickMsg$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ChatMsgFragment$clickMsg$1(this.this$0, this.$paramsMap, this.$context, this.$msgId, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) throws NoWhenBranchMatchedException {
        ...
        if (biliApiResponse instanceof BiliApiResponse.BusinessFailure) {
            ...
            BLog.e("ChatMsgFragment$clickMsg$1-invokeSuspend", "[together-watch-ChatMsgFragment$clickMsg$1-invokeSuspend] " + biliApiException.getMessage(), biliApiException);
            ...
            com.bilibili.biligame.dialogdispatcher.e.a("[together-watch-ChatMsgFragment$clickMsg$1-invokeSuspend] ", exception.getMessage(), "ChatMsgFragment$clickMsg$1-invokeSuspend", exception);
        } else {
            ...
            if (actionData.b() == 1 && (chatMsgA = actionData.a()) != null) {
                ...
                if (contentStr != null && contentStr.length() != 0) {
                    ...
                    if (xVar != null) {
                        ...
                        HD0.x.q(xVar, context, msgId, str, mapB, (season == null || (chatRoomInfo = season.E) == null) ? null : chatRoomInfo.E(), chatMsgA.getUser(), 64);
                    }
                    ...
                    HD0.x xVar2 = abstractC1534g3.f2505B;
                    if (xVar2 != null) {
                        xVar2.r(j7);
                    }
