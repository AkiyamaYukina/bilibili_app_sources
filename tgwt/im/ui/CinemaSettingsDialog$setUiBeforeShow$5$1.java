...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/tgwt/im/ui/CinemaSettingsDialog$setUiBeforeShow$5$1.class */
public final class CinemaSettingsDialog$setUiBeforeShow$5$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final CinemaSettingsDialog this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CinemaSettingsDialog$setUiBeforeShow$5$1(CinemaSettingsDialog cinemaSettingsDialog, Continuation<? super CinemaSettingsDialog$setUiBeforeShow$5$1> continuation) {
        super(2, continuation);
        this.this$0 = cinemaSettingsDialog;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CinemaSettingsDialog$setUiBeforeShow$5$1(this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i7 == 0) {
            ...
            String strValueOf = String.valueOf(this.this$0.f111243l.f2566w.getText());
            this.label = 1;
            if (chatRoomOperationService.roomModifyNotice(jT, strValueOf, this) == coroutine_suspended) {
