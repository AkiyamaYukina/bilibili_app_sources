...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/tgwt/im/ui/ChatMsgFragment$clickMsg$2.class */
final class ChatMsgFragment$clickMsg$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX INFO: loaded from: bili_base.jar:com/bilibili/tgwt/im/ui/ChatMsgFragment$clickMsg$2$a.class */
    public static final class a extends TypeToken<ChatMessageVo> {
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChatMsgFragment$clickMsg$2(ChatMsgFragment chatMsgFragment, ArrayMap<String, String> arrayMap, Context context, long j7, Continuation<? super ChatMsgFragment$clickMsg$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ChatMsgFragment$clickMsg$2(this.this$0, this.$paramsMap, this.$context, this.$msgId, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) throws NoWhenBranchMatchedException {
        ...
        if (biliApiResponse instanceof BiliApiResponse.BusinessFailure) {
            ...
            BLog.e("ChatMsgFragment$clickMsg$2-invokeSuspend", "[together-watch-ChatMsgFragment$clickMsg$2-invokeSuspend] " + biliApiException.getMessage(), biliApiException);
            ...
            com.bilibili.biligame.dialogdispatcher.e.a("[together-watch-ChatMsgFragment$clickMsg$2-invokeSuspend] ", exception.getMessage(), "ChatMsgFragment$clickMsg$2-invokeSuspend", exception);
        } else {
