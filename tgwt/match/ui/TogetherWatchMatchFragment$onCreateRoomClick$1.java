...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/tgwt/match/ui/TogetherWatchMatchFragment$onCreateRoomClick$1.class */
final class TogetherWatchMatchFragment$onCreateRoomClick$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final TogetherWatchMatchFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TogetherWatchMatchFragment$onCreateRoomClick$1(TogetherWatchMatchFragment togetherWatchMatchFragment, Continuation<? super TogetherWatchMatchFragment$onCreateRoomClick$1> continuation) {
        super(2, continuation);
        this.this$0 = togetherWatchMatchFragment;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new TogetherWatchMatchFragment$onCreateRoomClick$1(this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) throws NoWhenBranchMatchedException {
        ...
        if (i7 == 0) {
            ...
            long j7 = togetherWatchMatchFragment.f111481e;
            long j8 = togetherWatchMatchFragment.f111482f;
            int iVegaABTest = VegaManager.Companion.vegaABTest();
            int type = this.this$0.h.getType();
            String str = this.this$0.f111489n;
            this.label = 1;
            Object objCreateRoom = chatRoomOperationService.createRoom(j7, j8, 0, iVegaABTest, type, null, str, this);
            obj = objCreateRoom;
            if (objCreateRoom == coroutine_suspended) {
