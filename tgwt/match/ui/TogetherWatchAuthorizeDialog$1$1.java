...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/tgwt/match/ui/TogetherWatchAuthorizeDialog$1$1.class */
public final class TogetherWatchAuthorizeDialog$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final TogetherWatchAuthorizeDialog this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TogetherWatchAuthorizeDialog$1$1(TogetherWatchAuthorizeDialog togetherWatchAuthorizeDialog, Continuation<? super TogetherWatchAuthorizeDialog$1$1> continuation) {
        super(2, continuation);
        this.this$0 = togetherWatchAuthorizeDialog;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new TogetherWatchAuthorizeDialog$1$1(this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) throws NoWhenBranchMatchedException {
        ...
        if (i7 == 0) {
            ...
            this.label = 1;
            Object objForbiddenTogetherWatchAuthorize = chatRoomOperationService.forbiddenTogetherWatchAuthorize(0, this);
        ...
        if (biliApiResponse instanceof BiliApiResponse.BusinessFailure) {
            ...
            BLog.e("TogetherWatchAuthorizeDialog$1$1-invokeSuspend", "[together-watch-TogetherWatchAuthorizeDialog$1$1-invokeSuspend] " + biliApiException.getMessage(), biliApiException);
            ...
            com.bilibili.biligame.dialogdispatcher.e.a("[together-watch-TogetherWatchAuthorizeDialog$1$1-invokeSuspend] ", exception.getMessage(), "TogetherWatchAuthorizeDialog$1$1-invokeSuspend", exception);
        } else {
