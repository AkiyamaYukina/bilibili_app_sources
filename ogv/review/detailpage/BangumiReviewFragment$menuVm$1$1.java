...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/ogv/review/detailpage/BangumiReviewFragment$menuVm$1$1.class */
public final class BangumiReviewFragment$menuVm$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final BangumiReviewFragment this$0;

    /* JADX INFO: renamed from: com.bilibili.ogv.review.detailpage.BangumiReviewFragment$menuVm$1$1$1, reason: invalid class name */
    /* JADX INFO: loaded from: bili_base.jar:com/bilibili/ogv/review/detailpage/BangumiReviewFragment$menuVm$1$1$1.class */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BangumiReviewFragment$menuVm$1$1(BangumiReviewFragment bangumiReviewFragment, Continuation<? super BangumiReviewFragment$menuVm$1$1> continuation) {
        super(2, continuation);
        this.this$0 = bangumiReviewFragment;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new BangumiReviewFragment$menuVm$1$1(this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i7 == 0) {
            ...
            this.label = 1;
            if (oGVReviewService2.b(true, anonymousClass1, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i7 != 1) {
