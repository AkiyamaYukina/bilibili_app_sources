...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/ogv/review/detailpage/BangumiReviewFragment$onScoreHolderClick$1.class */
final class BangumiReviewFragment$onScoreHolderClick$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final BangumiReviewFragment this$0;

    /* JADX INFO: renamed from: com.bilibili.ogv.review.detailpage.BangumiReviewFragment$onScoreHolderClick$1$1, reason: invalid class name */
    /* JADX INFO: loaded from: bili_base.jar:com/bilibili/ogv/review/detailpage/BangumiReviewFragment$onScoreHolderClick$1$1.class */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BangumiReviewFragment$onScoreHolderClick$1(BangumiReviewFragment bangumiReviewFragment, Continuation<? super BangumiReviewFragment$onScoreHolderClick$1> continuation) {
        super(2, continuation);
        this.this$0 = bangumiReviewFragment;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new BangumiReviewFragment$onScoreHolderClick$1(this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i7 == 0) {
            ...
            if (bVar2.f72337o == 1) {
                ...
                OGVReviewService oGVReviewService3 = this.this$0.f72241m;
                ...
                this.label = 2;
                if (oGVReviewService3.a(bangumiReviewFragment, false, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
        } else {
