...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/ogv/filmlist/favorite/CreateFavoriteModel$invoke$1$toggleFavoriteState$1.class */
public final class CreateFavoriteModel$invoke$1$toggleFavoriteState$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public CreateFavoriteModel$invoke$1$toggleFavoriteState$1(a aVar, String str, CreateFavoriteModel$invoke$1 createFavoriteModel$invoke$1, Toaster toaster, Continuation<? super CreateFavoriteModel$invoke$1$toggleFavoriteState$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CreateFavoriteModel$invoke$1$toggleFavoriteState$1(this.this$0, this.$filmListId, this.this$1, this.$toaster, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) throws NoWhenBranchMatchedException {
        ...
        if (aVar instanceof KApiResponse.a) {
            ...
            Toaster.showToast$default(toaster, "已取消收藏", (ToastDuration) null, (ToastGravity) null, 6, (Object) null);
        }
