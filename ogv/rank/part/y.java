...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/ogv/rank/part/y.class */
public final class y implements Function4<LazyItemScope, Integer, Composer, Integer, Unit> {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final List f72130a;
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3, Object obj4) {
        ...
        if (composer.shouldExecute((i8 & 147) != 146, i8 & 1)) {
            ...
            List list = (List) this.f72130a.get(iIntValue);
            composer.startReplaceGroup(-1993332229);
            ...
            composer.startReplaceGroup(1964443485);
            Iterator it = list.iterator();
            while (it.hasNext()) {
                ((q) it.next()).invoke(RowScope.weight$default(rowScopeInstance, Modifier.Companion, 1.0f, false, 2, null), composer, 0);
            }
            composer.endReplaceGroup();
            if (list.size() < this.f72131b) {
                composer.startReplaceGroup(768389506);
                SpacerKt.Spacer(RowScope.weight$default(rowScopeInstance, Modifier.Companion, 1.0f, false, 2, null), composer, 0);
                composer.endReplaceGroup();
            } else {
                composer.startReplaceGroup(768484645);
                composer.endReplaceGroup();
            }
            if (F0.a.c(composer)) {
