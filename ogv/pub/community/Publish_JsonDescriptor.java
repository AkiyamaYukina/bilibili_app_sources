...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/ogv/pub/community/Publish_JsonDescriptor.class */
public final class Publish_JsonDescriptor extends PojoClassDescriptor {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public static final PojoPropertyDescriptor[] f71531a;
    ...
    public final Object get(Object obj, int i7) {
        ...
        switch (i7) {
            case 0:
                return publish.f71524a;
            case 1:
                return publish.f71525b;
            case 2:
                return Boolean.valueOf(publish.f71526c);
            case 3:
                return Boolean.valueOf(publish.f71527d);
            case 4:
                return Integer.valueOf(publish.f71528e);
            case 5:
                return publish.f71529f;
            case 6:
                return publish.f71530g;
            case 7:
