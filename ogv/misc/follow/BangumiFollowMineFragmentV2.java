...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/ogv/misc/follow/BangumiFollowMineFragmentV2.class */
...
public final class BangumiFollowMineFragmentV2 extends AbsFollowMainFragment implements IPvTracker {
    ...
    public final void qf() {
        ...
        if (pageAdapter != null) {
            pageAdapter.add(new AbsFollowMainFragment.a(1, 1, new FollowSubFragment()));
        }
        PageAdapter pageAdapter2 = this.f69010m;
        if (pageAdapter2 != null) {
            pageAdapter2.add(new AbsFollowMainFragment.a(1, 2, new FollowSubFragment()));
        }
        PageAdapter pageAdapter3 = this.f69010m;
        if (pageAdapter3 != null) {
            pageAdapter3.add(new AbsFollowMainFragment.a(1, 3, new FollowSubFragment()));
        }
    }

    @Override // com.bilibili.ogv.misc.follow.AbsFollowMainFragment
    public final void rf(int i7) {
        C8331z.a(i7 != 0 ? i7 != 2 ? "pgc.my-bangumi.group.watching.click" : "pgc.my-bangumi.group.watched.click" : "pgc.my-bangumi.group.will.click", null, null, null);
    }
}
