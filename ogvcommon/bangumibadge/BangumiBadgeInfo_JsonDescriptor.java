...
public final class BangumiBadgeInfo_JsonDescriptor extends PojoClassDescriptor {
    ...
    public final Object get(Object obj, int i7) {
        ...
        if (i7 == 0) {
            return bangumiBadgeInfo.f73144a;
        }
        if (i7 == 1) {
            return bangumiBadgeInfo.c();
        }
        if (i7 == 2) {
            return Integer.valueOf(bangumiBadgeInfo.d());
        }
        if (i7 == 3) {
            return bangumiBadgeInfo.f73147d;
        }
        if (i7 == 4) {
            return bangumiBadgeInfo.f73148e;
        }
        if (i7 != 5) {
            return null;
        }
        return bangumiBadgeInfo.b();
    }
}
