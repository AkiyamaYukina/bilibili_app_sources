...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/studio/centerplus/ui/dialog/ExitConfirmPublish0Dialog.class */
public final class ExitConfirmPublish0Dialog extends FrequencyBaseDialog {
    public ExitConfirmPublish0Dialog() {
        super(null);
    }
    ...
    public final void lf() {
        ...
        map.put("mid_type", String.valueOf(0));
    ...
    public final void onViewCreated(@NotNull View view, @Nullable Bundle bundle) {
        ...
        j.c("router_topic_id", g.f28463b);
        Map mapB = j.b(k.f28474a);
        ((HashMap) mapB).put("mid_type", String.valueOf(0));
