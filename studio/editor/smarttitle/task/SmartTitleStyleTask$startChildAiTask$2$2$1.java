...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/studio/editor/smarttitle/task/SmartTitleStyleTask$startChildAiTask$2$2$1.class */
final class SmartTitleStyleTask$startChildAiTask$2$2$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public SmartTitleStyleTask$startChildAiTask$2$2$1(SmartTitleStyleTask smartTitleStyleTask, String str, String str2, Continuation<? super SmartTitleStyleTask$startChildAiTask$2$2$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SmartTitleStyleTask$startChildAiTask$2$2$1(this.this$0, this.$styleName, this.$serverTaskId, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (smartTitleStyleTask.f108245i.get()) {
            BLog.e("SmartTitleTask", "该任务已经取消掉了～不再回调[onTaskCreated]");
        } else {
            g.a aVar = smartTitleStyleTask.f108246j;
            if (aVar != null) {
                String str3 = smartTitleStyleTask.f108238a;
