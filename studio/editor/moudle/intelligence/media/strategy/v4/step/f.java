...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/studio/editor/moudle/intelligence/media/strategy/v4/step/f.class */
public final class f extends com.bilibili.studio.editor.moudle.intelligence.media.strategy.v4.step.a {

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public final int f107504g;
    public final int h;

    /* JADX INFO: loaded from: bili_base.jar:com/bilibili/studio/editor/moudle/intelligence/media/strategy/v4/step/f$a.class */
    ...
    /* JADX INFO: loaded from: bili_base.jar:com/bilibili/studio/editor/moudle/intelligence/media/strategy/v4/step/f$b.class */
    ...
    /* JADX WARN: Type inference failed for: r6v0, types: [com.bilibili.studio.editor.moudle.intelligence.media.strategy.v4.step.a, com.bilibili.studio.editor.moudle.intelligence.media.strategy.v4.step.f] */
    @Override // com.bilibili.studio.editor.moudle.intelligence.media.strategy.v4.d
    @Nullable
    public final Object c(@NotNull GenerateJob generateJob, @NotNull Continuation<? super List<com.bilibili.studio.editor.moudle.intelligence.media.strategy.bean.a>> continuation) {
        ...
        if (i10 <= 0 || (i7 = this.h) <= 0 || (i8 = this.f107504g) <= 0) {
            objA = null;
        } else {
                ...
                if (arrayList7.size() >= iIntValue2) {
                    ...
                    if (mediaStrategyItem2 != null) {
                        ...
                        while (true) {
                            ...
                            i16 = i17 + 1;
                            aVar5.d(mutableList.subList(i17 * iMin, i16 * iMin));
    ...
    public final List<com.bilibili.studio.editor.moudle.intelligence.media.strategy.bean.a> f(a.d dVar, int i7) {
        ...
        for (a.a aVar : listTake) {
            ...
            List list3 = list2;
            aVar2.d(CollectionsKt.take(CollectionsKt.shuffled(list3), !aVar.b.isEmpty() ? 1 : this.f107504g));
