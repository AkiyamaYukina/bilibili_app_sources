...
/* JADX INFO: renamed from: com.bilibili.playset.detail.widget.e, reason: case insensitive filesystem */
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/playset/detail/widget/e.class */
public final /* synthetic */ class C5920e implements Function2 {
    public final Object invoke(Object obj, Object obj2) {
        Composer composer = (Composer) obj;
        int iIntValue = ((Integer) obj2).intValue();
        if (composer.shouldExecute((iIntValue & 3) != 2, iIntValue & 1)) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-747538936, iIntValue, -1, "com.bilibili.playset.detail.widget.ComposableSingletons$MultiTypeListDetailHeadContentKt.lambda$-747538936.<anonymous> (MultiTypeListDetailHeadContent.kt:212)");
            }
            IconKt.m1714Iconww6aTOc(DrawablePainterKt.rememberDrawablePainter(KtxKt.getAppCompatDrawable((Context) composer.consume(AndroidCompositionLocals_androidKt.getLocalContext()), 2131238923), composer, 0), (String) null, SizeKt.m1372size3ABfNKs(Modifier.Companion, Dp.m3880constructorimpl(24)), BiliTheme.INSTANCE.getColors(composer, BiliTheme.$stable).getText2-0d7_KjU(), composer, Painter.$stable | BLHumanActionParamsType.BL_HUMAN_ACTION_PARAM_SKIN_SEGMENT_MIN_THRESHOLD, 0);
            if (ComposerKt.isTraceInProgress()) {
