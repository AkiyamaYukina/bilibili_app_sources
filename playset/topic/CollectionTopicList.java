...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/playset/topic/CollectionTopicList.class */
...
public final class CollectionTopicList implements Parcelable {
    ...
    @NotNull
    public static final Parcelable.Creator<CollectionTopicList> CREATOR = new Object();
    public static final int $stable = 8;

    /* JADX INFO: loaded from: bili_base.jar:com/bilibili/playset/topic/CollectionTopicList$a.class */
    public static final class a implements Parcelable.Creator<CollectionTopicList> {
        @Override // android.os.Parcelable.Creator
        public final CollectionTopicList createFromParcel(Parcel parcel) {
            ArrayList arrayList;
            if (parcel.readInt() != 0) {
            ...
            return new CollectionTopicList(arrayList, parcel.readInt() == 0 ? null : PageInfo.CREATOR.createFromParcel(parcel));
        }

        @Override // android.os.Parcelable.Creator
        public final CollectionTopicList[] newArray(int i7) {
            return new CollectionTopicList[i7];
        }
    }
    ...
    public /* synthetic */ CollectionTopicList(List list, PageInfo pageInfo, int i7, DefaultConstructorMarker defaultConstructorMarker) {
        this((i7 & 1) != 0 ? null : list, (i7 & 2) != 0 ? null : pageInfo);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ CollectionTopicList copy$default(CollectionTopicList collectionTopicList, List list, PageInfo pageInfo, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public String toString() {
        return "CollectionTopicList(items=" + this.items + ", pageInfo=" + this.pageInfo + ")";
    }
