...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/search2/panel/SearchInlinePlayToastBean.class */
@Keep
final class SearchInlinePlayToastBean implements InterfaceC1403c {
    ...
    public String getMobileToast() {
        return h.a(2131847737, this.mobileNetworkToast);
    }
    ...
    public String getTipButtonText() {
        return h.a(2131841706, this.tipButton);
    }

    @Override // Ah0.InterfaceC1403c
    @NotNull
    public String getTipButtonToast() {
        return h.a(2131847910, this.buttonToast);
    }

    @Override // Ah0.InterfaceC1403c
    @NotNull
    public String getTipContent() {
        return h.a(2131847865, this.tipContentText);
    }
