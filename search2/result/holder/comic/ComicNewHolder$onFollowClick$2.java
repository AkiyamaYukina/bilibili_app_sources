...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/search2/result/holder/comic/ComicNewHolder$onFollowClick$2.class */
final class ComicNewHolder$onFollowClick$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final long $cid;
    int label;
    final ComicNewHolder this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ComicNewHolder$onFollowClick$2(long j7, ComicNewHolder comicNewHolder, Continuation<? super ComicNewHolder$onFollowClick$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ComicNewHolder$onFollowClick$2(this.$cid, this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            ...
            this.this$0.r0();
            ToastHelper.showToastShort(this.this$0.f88083a.a.getContext(), searchFollowResponse != null ? searchFollowResponse.getToast() : null);
