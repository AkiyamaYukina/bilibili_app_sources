...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/search2/result/holder/special/f.class */
public final class f extends BiliApiDataCallback<C2794o> {

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final g f88219b;
    ...
    public final void onError(Throwable th) {
        Context context = this.f88219b.itemView.getContext();
        if (context == null) {
            return;
        }
