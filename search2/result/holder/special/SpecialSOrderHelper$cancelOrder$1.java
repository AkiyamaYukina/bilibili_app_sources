...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/search2/result/holder/special/SpecialSOrderHelper$cancelOrder$1.class */
final class SpecialSOrderHelper$cancelOrder$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public SpecialSOrderHelper$cancelOrder$1(long j7, String str, BiliApiDataCallback<C2794o> biliApiDataCallback, Continuation<? super SpecialSOrderHelper$cancelOrder$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SpecialSOrderHelper$cancelOrder$1(this.$sid, this.$oid, this.$callback, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i7 == 0) {
                ...
                this.label = 1;
                Object objSuspendSearchReserveCancel = SearchMossKtxKt.suspendSearchReserveCancel(searchMoss, searchReserveRequestBuild, this);
                obj = objSuspendSearchReserveCancel;
                if (objSuspendSearchReserveCancel == coroutine_suspended) {
