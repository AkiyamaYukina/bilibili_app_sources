...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/search2/result/all/SearchResultAllFragment$initSwipeRefresh$1$1$1.class */
final class SearchResultAllFragment$initSwipeRefresh$1$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final com.bilibili.search2.result.base.v $it;
    int label;
    final SearchResultAllFragment this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SearchResultAllFragment$initSwipeRefresh$1$1$1(SearchResultAllFragment searchResultAllFragment, com.bilibili.search2.result.base.v vVar, Continuation<? super SearchResultAllFragment$initSwipeRefresh$1$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SearchResultAllFragment$initSwipeRefresh$1$1$1(this.this$0, this.$it, continuation);
    }
