...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/search2/result/loader/SearchOrderLoader$doOrder$1.class */
final class SearchOrderLoader$doOrder$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    final BiliApiDataCallback<C2795p> $callback;
    final SearchReserveInfo $searchReserveInfo;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SearchOrderLoader$doOrder$1(SearchReserveInfo searchReserveInfo, BiliApiDataCallback<C2795p> biliApiDataCallback, Continuation<? super SearchOrderLoader$doOrder$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new SearchOrderLoader$doOrder$1(this.$searchReserveInfo, this.$callback, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        try {
            if (i7 == 0) {
                ...
                this.label = 1;
                Object objSuspendSearchAddReserve = SearchMossKtxKt.suspendSearchAddReserve(searchMoss, reserveRequestBuild, this);
                obj = objSuspendSearchAddReserve;
                if (objSuspendSearchAddReserve == coroutine_suspended) {
