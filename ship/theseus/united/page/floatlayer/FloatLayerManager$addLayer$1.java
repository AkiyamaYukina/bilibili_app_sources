...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/ship/theseus/united/page/floatlayer/FloatLayerManager$addLayer$1.class */
final class FloatLayerManager$addLayer$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX INFO: renamed from: com.bilibili.ship.theseus.united.page.floatlayer.FloatLayerManager$addLayer$1$1, reason: invalid class name */
    /* JADX INFO: loaded from: bili_base.jar:com/bilibili/ship/theseus/united/page/floatlayer/FloatLayerManager$addLayer$1$1.class */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<UIComponent.ViewEntry, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            KProperty<Object>[] kPropertyArr = FloatLayerManager.f99637f;
            floatLayerManager.getClass();
            KProperty<Object> kProperty = FloatLayerManager.f99637f[0];
            root.setTag(floatLayerManager.f99642e, aVar);
            z.b(viewEntry.getRoot(), this.$layer.f99644b);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i7 == 0) {
            ResultKt.throwOnFailure(obj);
            UIComponent<?> uIComponent = this.$layer.f99643a;
