...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/ship/theseus/cheese/biz/intro/studyrecord/CheeseStudyCompletedComponent$fadeIn$1$1$1.class */
public final class CheeseStudyCompletedComponent$fadeIn$1$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public CheeseStudyCompletedComponent$fadeIn$1$1$1(CheeseStudyCompletedComponent.a.InterfaceC0641a interfaceC0641a, Animatable<Float, AnimationVector1D> animatable, int i7, Continuation<? super CheeseStudyCompletedComponent$fadeIn$1$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CheeseStudyCompletedComponent$fadeIn$1$1$1(this.$animationState, this.$alpha, this.$durationMillis, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i7 == 0) {
            ...
            if (interfaceC0641a instanceof CheeseStudyCompletedComponent.a.InterfaceC0641a.c) {
                ...
                TweenSpec tweenSpecTween$default = AnimationSpecKt.tween$default(this.$durationMillis, 0, C3348v.f33185c, 2, null);
                this.label = 1;
                ...
                if (interfaceC0641a instanceof CheeseStudyCompletedComponent.a.InterfaceC0641a.C0642a) {
                    Animatable<Float, AnimationVector1D> animatable2 = this.$alpha;
