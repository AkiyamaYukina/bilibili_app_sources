...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/ship/theseus/ogv/vip/playerlayer/OgvVipBarPlayerLayerService$runViewInfoExtra$2$1$4$2.class */
public final class OgvVipBarPlayerLayerService$runViewInfoExtra$2$1$4$2 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    int label;
    final OgvVipBarPlayerLayerService this$0;

    /* JADX INFO: renamed from: com.bilibili.ship.theseus.ogv.vip.playerlayer.OgvVipBarPlayerLayerService$runViewInfoExtra$2$1$4$2$1, reason: invalid class name */
    /* JADX INFO: loaded from: bili_base.jar:com/bilibili/ship/theseus/ogv/vip/playerlayer/OgvVipBarPlayerLayerService$runViewInfoExtra$2$1$4$2$1.class */
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OgvVipBarPlayerLayerService$runViewInfoExtra$2$1$4$2(OgvVipBarPlayerLayerService ogvVipBarPlayerLayerService, Continuation<? super OgvVipBarPlayerLayerService$runViewInfoExtra$2$1$4$2> continuation) {
        super(1, continuation);
        this.this$0 = ogvVipBarPlayerLayerService;
    }

    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new OgvVipBarPlayerLayerService$runViewInfoExtra$2$1$4$2(this.this$0, continuation);
    }
