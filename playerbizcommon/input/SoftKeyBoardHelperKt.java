...
/* JADX INFO: loaded from: bili_base.jar:com/bilibili/playerbizcommon/input/SoftKeyBoardHelperKt.class */
public final class SoftKeyBoardHelperKt {

    /* JADX INFO: loaded from: bili_base.jar:com/bilibili/playerbizcommon/input/SoftKeyBoardHelperKt$a.class */
    public static final class a extends WindowInsetsAnimationCompat.Callback {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public final View f80100a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        public final View f80101b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        public final Ref.BooleanRef f80102c;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        public final Window f80103d;

        /* JADX INFO: renamed from: e, reason: collision with root package name */
        public final Ref.ObjectRef<WindowInsetsAnimationCompat> f80104e;

        /* JADX INFO: renamed from: f, reason: collision with root package name */
        public final Ref.BooleanRef f80105f;

        /* JADX INFO: renamed from: g, reason: collision with root package name */
        public final View f80106g;
        public final Ref.IntRef h;

        /* JADX INFO: renamed from: i, reason: collision with root package name */
        public final Function1<Boolean, Unit> f80107i;

        /* JADX INFO: renamed from: j, reason: collision with root package name */
        public final Ref.FloatRef f80108j;
        ...
        public a(View view, View view2, Ref.BooleanRef booleanRef, Window window, Ref.ObjectRef<WindowInsetsAnimationCompat> objectRef, Ref.BooleanRef booleanRef2, View view3, Ref.IntRef intRef, Function1<? super Boolean, Unit> function1, Ref.FloatRef floatRef) {
            ...
            this.f80100a = view;
            this.f80101b = view2;
            this.f80102c = booleanRef;
            this.f80103d = window;
            this.f80104e = objectRef;
            this.f80105f = booleanRef2;
            this.f80106g = view3;
            this.h = intRef;
            this.f80107i = function1;
            this.f80108j = floatRef;
        }
        ...
        public final void onEnd(WindowInsetsAnimationCompat windowInsetsAnimationCompat) {
            ...
            if (!this.f80105f.element || (function1 = this.f80107i) == null) {
                return;
            }
            function1.invoke(Boolean.valueOf(this.f80102c.element));
        }

        @Override // androidx.core.view.WindowInsetsAnimationCompat.Callback
        public final WindowInsetsCompat onProgress(WindowInsetsCompat windowInsetsCompat, List<WindowInsetsAnimationCompat> list) {
            int i7;
            WindowInsetsAnimationCompat windowInsetsAnimationCompat = (WindowInsetsAnimationCompat) this.f80104e.element;
            Float fValueOf = windowInsetsAnimationCompat != null ? Float.valueOf(windowInsetsAnimationCompat.getFraction()) : null;
            if (fValueOf != null && this.f80100a != null && this.f80101b != null && this.f80105f.element) {
                int bottom = this.f80103d.getDecorView().getBottom() - windowInsetsCompat.getInsets(WindowInsetsCompat.Type.ime()).bottom;
                boolean z6 = this.f80102c.element;
                Ref.FloatRef floatRef = this.f80108j;
                if (z6 && bottom < (i7 = this.h.element)) {
                    float f7 = bottom - i7;
                    this.f80101b.setTranslationY(f7);
                    floatRef.element = f7;
                } else if (!z6) {
                    View view = this.f80101b;
        ...
        */
        public final androidx.core.view.WindowInsetsAnimationCompat.BoundsCompat onStart(androidx.core.view.WindowInsetsAnimationCompat r5, androidx.core.view.WindowInsetsAnimationCompat.BoundsCompat r6) {
            /*
                r4 = this;
                r0 = r4
                android.view.View r0 = r0.f80100a
                if (r0 == 0) goto La0
                r0 = r4
                android.view.View r0 = r0.f80101b
                if (r0 != 0) goto L11
                goto La0
            L11:
                r0 = r4
                android.view.Window r0 = r0.f80103d
            ...
            L35:
                r0 = r4
                kotlin.jvm.internal.Ref$BooleanRef r0 = r0.f80102c
                r11 = r0
                r0 = r11
                r1 = r9
                r0.element = r1
                r0 = r4
                kotlin.jvm.internal.Ref$ObjectRef<androidx.core.view.WindowInsetsAnimationCompat> r0 = r0.f80104e
                r1 = r5
                r0.element = r1
                r0 = r11
                ...
                if (r0 == 0) goto L72
                r0 = r4
                android.view.View r0 = r0.f80106g
                r5 = r0
                r0 = r5
                if (r0 == 0) goto L66
                r0 = r10
            ...
            L69:
                r0 = r4
                kotlin.jvm.internal.Ref$BooleanRef r0 = r0.f80105f
                r1 = r9
                r0.element = r1
            L72:
                r0 = r11
            ...
            La0:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bilibili.playerbizcommon.input.SoftKeyBoardHelperKt.a.onStart(androidx.core.view.WindowInsetsAnimationCompat, androidx.core.view.WindowInsetsAnimationCompat$BoundsCompat):androidx.core.view.WindowInsetsAnimationCompat$BoundsCompat");
        }
    }
    ...
    public static final void setWindowSoftInput(@NotNull final Window window, @Nullable View view, @Nullable final View view2, @Nullable final View view3, @Nullable final Function1<? super Boolean, Unit> function1) {
        if (!isSystemInsetsAnimationSupport(window.getDecorView())) {
            ...
            window.getDecorView().getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener(window, booleanRef2, view3, booleanRef, function1, view2) { // from class: Cq0.k

                /* JADX INFO: renamed from: a, reason: collision with root package name */
                public final Window f1724a;

                /* JADX INFO: renamed from: b, reason: collision with root package name */
                public final Ref.BooleanRef f1725b;

                /* JADX INFO: renamed from: c, reason: collision with root package name */
                public final View f1726c;

                /* JADX INFO: renamed from: d, reason: collision with root package name */
                public final Ref.BooleanRef f1727d;

                /* JADX INFO: renamed from: e, reason: collision with root package name */
                public final Function1 f1728e;

                /* JADX INFO: renamed from: f, reason: collision with root package name */
                public final View f1729f;

                {
                    this.f1724a = window;
                    this.f1725b = booleanRef2;
                    this.f1726c = view3;
                    this.f1727d = booleanRef;
                ...
                public final void onGlobalLayout() {
                    ...
                    Window window2 = this.f1724a;
                    Ref.BooleanRef booleanRef3 = this.f1725b;
                    View view4 = this.f1726c;
                    Ref.BooleanRef booleanRef4 = this.f1727d;
                    Function1 function12 = this.f1728e;
                    View view5 = this.f1729f;
    ...
    public static final void showSoftInput(@NotNull EditText editText) {
        ...
        if (!isSystemInsetsAnimationSupport(editText)) {
            editText.postDelayed(new l(editText, 0), 150L);
            return;
        }
